...
class TLE 
{
    ...
    parseLines(line1, line2)
    {
        ...
        this.epoch = this.parseEpoch(line1split[3]);

        this.ndot = Number(line1split[4]);
        this.nddot = line1split[5].split(/[\+|-]/).filter(s => s.length > 0);
        let pos = line1split[5].search('-') === -1
        if (this.nddot.length === 3) {
            this.nddot = [-1*this.nddot[1], this.nddot[2]]
        }
        ...
        this.raanDeg = Number(line2split[3])
        this.ecc = Number('.'+line2split[4])
        this.argpDeg = Number(line2split[5])
        this.maDeg = Number(line2split[6])
        
        this.n = Number(line2split[7])
    ...
    parseEpoch(str)
    {
        ...
        var d = new Date(year, mon-1, day, hr, mn, sec);
